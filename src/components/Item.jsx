...
export default function Item(props) {
  return (
    <div className="relative flex h-[620px] w-[380px] flex-1 cursor-pointer flex-col items-center justify-center gap-4 rounded-lg border-2 border-[#c770f0] p-5 duration-700 hover:scale-95">
